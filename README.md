...
I used [colormind.io](http://colormind.io/) to decide on the colour scheme of the site, to achieve the retro feel I intended. I used simple pixalated imagery to make the 
...
it wasnt in keeping with the retro feel I wanted. 

![Logos generated by AI](assets/images/testing/AI-logos.png)

**Fonts**

To excentuate the retro feel of the games from [Google Fonts](https://fonts.google.com/) I choose:
- Caveat
- Permanent Marker
- Roboto Mono
